        ...
        <div className="flex flex-col md:flex-row justify-between max-w-4xl mx-auto">
          ...
          <div className="mb-8 md:mb-0 md:w-[30%]">
            <ul className="space-y-4">
              <li>
                <a href="#" className="text-gray-800 hover:text-red-500 block pb-2 border-b border-gray-300 hover:translate-x-1 transform transition-transform duration-300">Home</a>
              </li>
              <li>
                <a href="#" className="text-gray-800 hover:text-red-500 block pb-2 border-b border-gray-300 hover:translate-x-1 transform transition-transform duration-300">About Us</a>
              </li>
              <li>
                <a href="/ServicesSection" className="text-gray-800 hover:text-red-500 block pb-2 border-b border-gray-300 hover:translate-x-1 transform transition-transform duration-300">Our Services</a>
              </li>
              <li>
                <a href="#" className="text-gray-800 hover:text-red-500 block pb-2 border-b border-gray-300 hover:translate-x-1 transform transition-transform duration-300">Gallery</a>
              </li>
              <li>
                <a href="/packages" className="text-gray-800 hover:text-red-500 block pb-2 border-b border-gray-300 hover:translate-x-1 transform transition-transform duration-300">Packages</a>
              </li>
            </ul>
          </div>
          ...
          <div className="flex space-x-4 relative mb-6">
            ...
            <div className="group relative">
              <a href="#" className="bg-black text-white p-2 rounded-full block hover:bg-[#B1153C] transition-colors transform hover:scale-110 transition-transform duration-300">
            ...
            {/* Instagram */}
            <div className="group relative">
              <a href="https://www.instagram.com/akaay_mini_theater?igsh=Z3E4cWJtcmpweG94" target='_blank' className="bg-black text-white p-2 rounded-full block hover:bg-[#B1153C] transition-colors transform hover:scale-110 transition-transform duration-300">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* YouTube */}
            <div className="group relative">
              <a href="https://youtube.com/shorts/DwLtSNo9eSk?si=UbbNgzM1VA3Ypae3" target='_blank' className="bg-black text-white p-2 rounded-full block hover:bg-[#B1153C] transition-colors transform hover:scale-110 transition-transform duration-300">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
